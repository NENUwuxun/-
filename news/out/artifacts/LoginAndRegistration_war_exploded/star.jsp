    ...
    <div class="row clearfix navigation">
        ...
        <div class="col-md-8 column">
            <ul class="ul-nav">
                ...
                <li id="nav-li14">
                    <a href="ClassServlet?cat_id=1" target="myframe">热点排行</a>
                </li>
            </ul>
        </div>
        <div class="col-md-2 column">
    ...
    <div class="row clearfix bottom">
        ...
        <div class="col-md-6 column">
            <div class="ul-outer">
                <ul class="ul-page">
                    <li>
                        <a href="UserShowServlet?page=${paging.page-1}" >上一页</a>
                    </li>
                    <li>
                        <a href="UserShowServlet?page=1" target="myframe" id="head">首页</a>
                    </li>
                    <li>
                        <a href="UserShowServlet?page=${paging.page+1}" target="myframe">
                            <div class="div-page" id="page1">1</div>
                        </a>
                    </li>
                    <li>
                        <a href="UserShowServlet?page=2" target="myframe">
                            <div class="div-page" id="page2">2</div>
                        </a>
                    </li>
                    <li>
                        <a href="UserShowServlet?page=3" target="myframe">
                    ...
                    <li>
                        <a href="UserShowServlet?page=12" target="myframe">
                            <div class="div-page" id="page12">12</div>
                        </a>
                    </li>
                    <li>
                        <a href="UserShowServlet?page=13" target="myframe">
                            <div class="div-page" id="page13">13</div>
                        </a>
                    </li>
                    <li>
                        <a href="UserShowServlet?page=14" target="myframe">
                            <div class="div-page" id="page14">14</div>
                        </a>
                    </li>
                    <li>
                        <a href="UserShowServlet?page=${paging.totalPage}" id="end" target="myframe">尾页</a>
                    </li>
                    <li>
                        <a href="UserShowServlet?page=${paging.page+1}" id="nex">下一页</a>
                    </li>
                </ul>
            </div>
